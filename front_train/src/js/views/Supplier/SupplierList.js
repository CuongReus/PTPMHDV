                ...
                <div className="content">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                                    ...
                                    <form className="main-search" role="form">
                                        <div className="input-group content-group">
                                            <div className="has-feedback has-feedback-left">
                                                <input type="text" className="form-control input-xlg" placeholder="Tìm kiếm theo: Tên Nhà Cung cấp, Tên Sản Phẩm Cung Cấp..." name="search" defaultValue={search} autoFocus={true} />
                            ...
                            <div className="panel panel-flat">
                                <table style={{fontSize:"11px"}} className="table table-xxs table-bordered">
                                    <thead>
                                        <tr className="bg-green">
                                            <th data-toggle="true">STT</th>
                                            <th data-toggle="true">Nhà Cung Cấp</th>
                                            <th style={{whiteSpace:'nowrap'}} data-hide="phone">Sản Phẩm Cung Cấp</th>
