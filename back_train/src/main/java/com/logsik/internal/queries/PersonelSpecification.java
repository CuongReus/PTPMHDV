package com.logsik.internal.queries;
...
public class PersonelSpecification implements Specification<User> {
	...
	public PersonelSpecification(String companyId, String fullNameOrPhoneOrEmail) {
	...
	public Predicate toPredicate(Root<User> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
		...
		query.orderBy(builder.desc(root.get("company").get("id")));
